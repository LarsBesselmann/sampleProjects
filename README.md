...
6. Deploy the genefrated war file to the tWAS cluster, set the context root to **/tWAS**
...
2. Start the AMA Dev Tool modernization wizard for target Liberty

	<kbd>![](./images/media/AMADevTool_ModernizationWizard1.png)</kbd>


3. Upload the AMA generated migration plan into AMA Dev Tools

	<kbd>![](./images/media/AMADevTool_ModernizationWizard2.png)</kbd>

4. Add the generated server.xml file which was generated by AMA and helps to test the application in development on Liberty.

	<kbd>![](./images/media/AMADevTool_ModernizationWizard3.png)</kbd>

5. Take a look at the identified modernization issues which are mainly in the are ap automated fixes

	<kbd>![](./images/media/AMADevTool_ModernizationWizard4.png)</kbd>

	Click on **Run automated fixes** to fix those issues.

6. Click on Rebuild and refresh and you will see that also the self-directed issue has been resolved.

	<kbd>![](./images/media/AMADevTool_ModernizationWizard5.png)</kbd>



## Set up the managed Liberty cluster and deploy the application
